...
const Card = React.forwardRef(({ className, ...props }, ref) => ((0, jsx_runtime_1.jsx)("div", { ref: ref, className: (0, utils_1.cn)('bg-card text-card-foreground rounded-xl border shadow', className), ...props })));
exports.Card = Card;
...
const CardTitle = React.forwardRef(({ className, children, ...props }, ref) => ((0, jsx_runtime_1.jsx)("h3", { ref: ref, className: (0, utils_1.cn)('font-semibold leading-none tracking-tight', className), ...props, children: children || 'Default Title' })));
exports.CardTitle = CardTitle;
CardTitle.displayName = 'CardTitle';
const CardDescription = React.forwardRef(({ className, ...props }, ref) => ((0, jsx_runtime_1.jsx)("p", { ref: ref, className: (0, utils_1.cn)('text-muted-foreground text-sm', className), ...props })));
