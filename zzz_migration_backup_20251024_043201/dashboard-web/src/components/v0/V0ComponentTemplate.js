...
const LoadingSpinner = ({ size = 'md' }) => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: cn('animate-spin rounded-full border-2 border-gray-300 border-t-blue-600', sizeClasses[size]) }));
};
...
const V0ComponentTemplate = ({ title = 'Componente V0', description, variant = 'default', size = 'md', disabled = false, loading = false, onAction, onCancel, className, children, }) => {
    ...
    if (loadingState.error) {
        return ((0, jsx_runtime_1.jsx)("div", { className: cn('rounded-lg border', className), children: (0, jsx_runtime_1.jsx)(ErrorMessage, { message: loadingState.error, onRetry: () => {
                    reset();
                    handleAction();
                } }) }));
    }
...
const V0ModalTemplate = ({ isOpen, onClose, title, size = 'md', className, children }) => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: "fixed inset-0 z-50 overflow-y-auto", children: (0, jsx_runtime_1.jsxs)("div", { className: "flex min-h-full items-center justify-center p-4", children: [(0, jsx_runtime_1.jsx)("button", { className: "fixed inset-0 bg-black bg-opacity-25", onClick: onClose, onKeyDown: handleBackdropClick, "aria-label": "Cerrar modal" }), (0, jsx_runtime_1.jsxs)("div", { className: cn('relative w-full rounded-lg bg-white shadow-xl', sizeClasses[size], className), children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between border-b border-gray-200 p-6", children: [(0, jsx_runtime_1.jsx)("h3", { className: "text-lg font-medium text-gray-900", children: title }), (0, jsx_runtime_1.jsx)("button", { onClick: onClose, className: "text-gray-400 hover:text-gray-600", "aria-label": "Cerrar", children: "\u2715" })] }), (0, jsx_runtime_1.jsx)("div", { className: "p-6", children: children })] })] }) }));
};
