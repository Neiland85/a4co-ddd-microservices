...
const mockArtisans = [
    {
        ...
        description: 'Cooperativa fundada en 1952 que agrupa a más de 300 olivicultores de la región. Especializada en aceite de oliva virgen extra de variedad Picual.',
        experience: 72,
    ...
    },
    {
        ...
        description: 'Quesería familiar que elabora quesos artesanales con leche de cabras criadas en libertad en el Parque Natural de Cazorla.',
        experience: 25,
    ...
    },
    {
        ...
        description: 'Taller familiar fundado en 1928, especializado en cerámica vidriada tradicional de Úbeda con técnicas transmitidas de generación en generación.',
        experience: 96,
...
async function GET(request) {
    ...
    try {
        ...
        if (municipality) {
            filteredArtisans = filteredArtisans.filter(artisan => artisan.location.municipality.toLowerCase().includes(municipality.toLowerCase()));
        }
        if (specialty) {
            filteredArtisans = filteredArtisans.filter(artisan => artisan.specialty.toLowerCase().includes(specialty.toLowerCase()));
        }
        if (verified === 'true') {
        ...
        if (search) {
            ...
            filteredArtisans = filteredArtisans.filter(artisan => artisan.name.toLowerCase().includes(searchLower) ||
