...
const FormDescription = React.forwardRef(({ className, ...props }, ref) => {
    ...
    return ((0, jsx_runtime_1.jsx)("p", { ref: ref, id: formDescriptionId, className: (0, utils_1.cn)('text-muted-foreground text-sm', className), ...props }));
});
...
const FormMessage = React.forwardRef(({ className, children, ...props }, ref) => {
    ...
    return ((0, jsx_runtime_1.jsx)("p", { ref: ref, id: formMessageId, className: (0, utils_1.cn)('text-destructive text-sm font-medium', className), ...props, children: body }));
});
