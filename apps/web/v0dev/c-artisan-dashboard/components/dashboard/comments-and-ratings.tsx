...
export function CommentsAndRatings({ metrics }: CommentsAndRatingsProps) {
  ...
  return (
    <div className="space-y-6 relative">
      ...
      <SectionCircles section="comments" animationParams={animationParams} metrics={{ comments: metrics }} />
      ...
      >
        <h2 className="text-3xl font-bold text-gray-900 mb-2">Comentarios y Puntuaciones</h2>
        ...
        >
          <Card className="relative overflow-hidden bg-white/90 backdrop-blur-sm border-slate-200/60 hover:shadow-lg transition-all duration-300">
            ...
            <div className="absolute inset-0 opacity-5 pointer-events-none">
              <motion.div
                className="absolute top-0 left-0 w-full h-0.5 bg-gradient-to-r from-pink-600/60 via-transparent to-fuchsia-500/40"
                animate={{
                  opacity: [0.3, 0.8, 0.3],
                }}
                transition={{
      ...
      <div className="space-y-4 relative z-10">
        {comments.map((comment, index) => (
          ...
          >
            <Card className="hover:shadow-lg transition-all duration-300 relative overflow-hidden bg-white/90 backdrop-blur-sm border-slate-200/60">
              {/* Textura para comentarios animada */}
              <div className="absolute inset-0 opacity-3 pointer-events-none">
                <motion.div
                  className="absolute top-0 right-0 w-12 h-12 bg-gradient-radial from-pink-500/50 to-transparent rounded-full blur-lg"
                  animate={{
                    scale: [1, 1.3, 1],
                    opacity: [0.3, 0.6, 0.3],
                  }}
                ...
                />
                <motion.div
                  className="absolute bottom-0 left-0 w-8 h-8 bg-gradient-radial from-fuchsia-400/40 to-transparent rounded-full blur-lg"
                  animate={{
                    x: [0, 10, 0],
                    y: [0, -5, 0],
                    scale: [0.8, 1.2, 0.8],
