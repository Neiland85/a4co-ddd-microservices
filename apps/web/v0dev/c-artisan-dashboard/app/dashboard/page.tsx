      ...
      <AnimatePresence>
        {isTransitioning && (
          <motion.div
            ...
            className="z-5 pointer-events-none fixed inset-0 bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-pink-500/10"
          />
        )}
      </AnimatePresence>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {activeSection === 'recommendations' && (
              <InteractiveRecommendations metrics={metrics.recommendations} />
            )}
