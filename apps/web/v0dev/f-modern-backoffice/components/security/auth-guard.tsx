            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              {isLocked && (
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    Cuenta bloqueada por seguridad. Tiempo restante: {Math.ceil(lockTimeRemaining / 60)} minutos
                  </AlertDescription>
                </Alert>
              )}
      ...
      <div className="min-h-screen flex items-center justify-center">
        <Card className="w-full max-w-md">
          ...
          <CardContent className="text-center space-y-4">
            ...
            <div>
              <p className="text-sm text-muted-foreground">Permisos requeridos: {requiredPermissions.join(", ")}</p>
            </div>
