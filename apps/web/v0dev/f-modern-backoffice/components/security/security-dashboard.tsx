  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setMetrics(prev => ({
        ...
        suspiciousActivities: Math.max(
          0,
          prev.suspiciousActivities + Math.floor(Math.random() * 2) - 1
        ),
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">Últimas 24 horas</p>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Amenazas detectadas y acciones de seguridad en tiempo real
          </CardDescription>
        </CardHeader>
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              ...
              <span className="text-muted-foreground text-sm">
                {metrics.blockedIPs} IPs bloqueadas
              </span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              ...
              <span className="text-muted-foreground text-sm">
                {metrics.lastScan.toLocaleTimeString('es-ES')}
              </span>
            </div>
          </CardContent>
        </Card>
