        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {featuredOffers.filter(o => o.status === 'active').length}
            </div>
                ...
                <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
                  ...
                  <DialogContent className="max-w-2xl">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Configura una nueva oferta para destacar en la plataforma
                      </DialogDescription>
                    </DialogHeader>
                ...
                <TableBody>
                  {featuredOffers.map(offer => (
                    <TableRow key={offer.id}>
                      <TableCell>
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <div className="text-muted-foreground text-sm">{offer.category}</div>
                          </div>
                        </div>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        <Badge className={`${getPriorityColor(offer.priority)} text-white`}>
                          {offer.priority}
                        </Badge>
                      </TableCell>
                      <TableCell>
                        <div className="text-sm">
                          ...
                          <div className="flex items-center text-green-600">
                            <Euro className="mr-1 h-3 w-3" />€{offer.revenue}
                          </div>
                        </div>
                      </TableCell>
                      <TableCell>
                        <div className="text-sm">
                          ...
                          <div className="text-muted-foreground">
                            {offer.endDate.toLocaleDateString('es-ES')}
                          </div>
                        </div>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        <div>
                          ...
                          <div className="text-muted-foreground text-sm">
                            {campaign.businesses.length} negocios
                          </div>
                        </div>
                      </TableCell>
                      <TableCell>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      <span className="text-muted-foreground text-sm">Tasa de Conversión</span>
                      <span className="font-medium">9.2%</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground text-sm">CTR Promedio</span>
                      <span className="font-medium">12.5%</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground text-sm">Valor Promedio</span>
