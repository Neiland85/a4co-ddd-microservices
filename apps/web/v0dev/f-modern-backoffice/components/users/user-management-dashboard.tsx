    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{businessUsers.filter((u) => u.isPremium).length}</div>
            <div className="flex items-center text-xs text-muted-foreground">
              <TrendingUp className="h-3 w-3 mr-1 text-green-500" />
              +25% conversión
            </div>
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-muted-foreground flex items-center">
                              {business.isPremium && <Crown className="h-3 w-3 mr-1 text-yellow-500" />}
        ...
        <TabsContent value="customers" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Administra todos los usuarios clientes de la plataforma</CardDescription>
            </CardHeader>
            <CardContent>
              {/* Filtros */}
              <div className="flex space-x-2 mb-4">
                ...
                >
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={userGrowthData}>
                      ...
                      <Line type="monotone" dataKey="businesses" stroke="var(--color-businesses)" strokeWidth={2} />
