  ...
  return (
    <Card className="col-span-full">
      <CardHeader>
        ...
        <CardDescription>
          Registro detallado de eventos del sistema y actividad de usuarios
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4 border-t pt-4 md:grid-cols-4">
          ...
          <div className="text-center">
            ...
            <div className="text-muted-foreground text-xs">Advertencias</div>
          </div>
          <div className="text-center">
            <div className="text-lg font-semibold text-green-500">
              {events.filter(e => e.type === 'success').length}
            </div>
            <div className="text-muted-foreground text-xs">Éxitos</div>
          </div>
          <div className="text-center">
            <div className="text-lg font-semibold text-blue-500">
              {events.filter(e => e.type === 'security').length}
            </div>
            <div className="text-muted-foreground text-xs">Seguridad</div>
          </div>
        </div>
      </CardContent>
    </Card>
