...
const AvatarFallback = React.forwardRef(({ className, ...props }, ref) => ((0, jsx_runtime_1.jsx)(AvatarPrimitive.Fallback, { ref: ref, className: (0, utils_1.cn)('bg-muted flex h-full w-full items-center justify-center rounded-full', className), ...props })));
