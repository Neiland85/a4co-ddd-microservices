    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Gestiona la configuración de tu negocio y privacidad</p>
        </div>
      </div>
        ...
        <TabsContent value="business">
          <Card className="shadow-natural-lg hover:shadow-natural-xl transition-all duration-300">
            <CardHeader>
              ...
              <CardDescription>Configura la información básica de tu negocio artesanal</CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <CardContent className="space-y-6">
              {[
                ...
                <div
                  ...
                  className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-all duration-300 hover:scale-102 hover:shadow-natural-md"
                >
          ...
          <div className="space-y-6">
            <Card className="shadow-natural-lg hover:shadow-natural-xl transition-all duration-300">
              ...
              <CardContent className="space-y-6">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500">Tiempo que se conservarán los datos de clientes inactivos</p>
                </div>

                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-all duration-300 hover:scale-102">
                  <div className="flex-1">
                    <div className="font-medium text-gray-900">Consentimiento de Cookies</div>
                    <div className="text-sm text-gray-600">Solicitar consentimiento para cookies no esenciales</div>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-all duration-300 hover:scale-102">
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-600">Permitir recopilación de datos analíticos</div>
                  </div>
                  <Switch
            ...
            <Alert className="border-yellow-200 bg-yellow-50">
              ...
              <AlertDescription className="text-yellow-800">
                Los cambios en la configuración de privacidad pueden afectar la funcionalidad de tu tienda. Asegúrate de
                    ...
                    <DialogContent>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex justify-end space-x-2">
                          <Button variant="outline" onClick={() => setIsExportDialogOpenData(false)}>
                            Cancelar
                          </Button>
                          <Button
                            onClick={() => {
                            ...
                            className="bg-gradient-to-r from-a4co-olive-500 to-a4co-clay-500 hover:from-a4co-olive-600 hover:to-a4co-clay-600"
                          >
                            <Download className="h-4 w-4 mr-2" />
                            Exportar
                          </Button>
                  ...
                  {dataRequestsData.map((request) => {
                    ...
                    return (
                      <div
                        ...
                        className={cn(
                          "p-4 border rounded-lg transition-all duration-300 hover:shadow-natural-md cursor-pointer",
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex-1">
                            ...
                            <div className="text-xs text-gray-500">
                              ...
                              {request.completedDate && ` • Completado: ${formatDate(request.completedDate)}`}
                            </div>
                          ...
                          {request.status === "pending" && (
                            <div className="flex space-x-2">
                              <Button
                                ...
                                className="hover:scale-110 transition-all duration-300 hover:bg-green-50 hover:text-green-600 hover:border-green-300"
                              >
                              ...
                              <Button
                                ...
                                className="hover:scale-110 transition-all duration-300 hover:bg-red-50 hover:text-red-600 hover:border-red-300"
                              >
