    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-gray-600">Gestiona todos los pedidos de tu tienda</p>
        </div>
      </div>
            ...
            >
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className={cn(
                      'rounded-lg p-2 transition-all duration-300 group-hover:rotate-12 group-hover:scale-110',
                      stat.bgColor
                    )}
                  >
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="px-4 py-3 text-left font-medium text-gray-900">ID Pedido</th>
                  <th className="px-4 py-3 text-left font-medium text-gray-900">Cliente</th>
                  <th className="px-4 py-3 text-left font-medium text-gray-900">Productos</th>
                  ...
                  <th className="px-4 py-3 text-left font-medium text-gray-900">Fecha</th>
                ...
                {paginatedOrders.map(order => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-4">
                        <Badge className={cn('border text-xs', getStatusColor(order.status))}>
                            ...
                            {selectedOrder && (
                              <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                  ...
                                  <Badge
                                    className={cn('text-sm', getStatusColor(selectedOrder.status))}
                                  >
                                ...
                                <div className="border-t pt-4">
                                  <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-a4co-olive-600 text-xl font-bold">
