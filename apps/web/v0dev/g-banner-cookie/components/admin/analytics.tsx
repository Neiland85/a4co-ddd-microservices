...
export default function Analytics() {
  ...
  const summary: AnalyticsSummary = useMemo(() => {
    ...
    const topCategory =
      mockCategoryData.toSorted((a, b) => b.value - a.value)[0]?.category || 'N/A';
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-gray-600">Análisis detallado de ventas y tendencias</p>
        </div>
        ...
        {[
          ...
          return (
            <Card
              key={stat.title}
              className={cn(
                'hover:shadow-natural-lg group cursor-pointer border-2 transition-all duration-300 hover:scale-105',
                stat.borderColor
              )}
            >
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-gray-200">
                        ...
                        <th className="px-4 py-3 text-left font-medium text-gray-900">Ventas</th>
                        <th className="px-4 py-3 text-left font-medium text-gray-900">
                          Porcentaje
                        </th>
                        <th className="px-4 py-3 text-left font-medium text-gray-900">Tendencia</th>
                      </tr>
                    </thead>
                    <tbody>
                      {mockCategoryData
      ...
      <Card className="shadow-natural-lg">
        <CardHeader>
          <CardTitle className="flex items-center">
            <Target className="text-a4co-olive-600 mr-2 h-5 w-5" />
            Insights Clave
          </CardTitle>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-lg border border-green-200 bg-green-50 p-4">
              ...
              <p className="text-sm text-green-700">
                Los ingresos han crecido un {summary.growthRate.toFixed(1)}% comparado con el
                período anterior. El producto "{summary.topProduct}" lidera las ventas.
              </p>
            </div>
            ...
            <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
              ...
              <p className="text-sm text-blue-700">
                La tasa de conversión actual es del {summary.conversionRate}%. Los clientes
                recurrentes representan el 65% de las ventas totales.
              </p>
            </div>
            ...
            <div className="rounded-lg border border-amber-200 bg-amber-50 p-4">
              ...
              <p className="text-sm text-amber-700">
                La categoría "{summary.topCategory}" tiene el mayor potencial de crecimiento.
                Considera expandir el inventario en esta área.
              </p>
            </div>
          </div>
        </CardContent>
