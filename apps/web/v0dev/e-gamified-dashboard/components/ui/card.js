...
const Card = React.forwardRef(({ className, ...props }, ref) => ((0, jsx_runtime_1.jsx)("div", { ref: ref, className: (0, utils_1.cn)('bg-card text-card-foreground rounded-lg border shadow-sm', className), ...props })));
exports.Card = Card;
...
const CardDescription = React.forwardRef(({ className, ...props }, ref) => ((0, jsx_runtime_1.jsx)("div", { ref: ref, className: (0, utils_1.cn)('text-muted-foreground text-sm', className), ...props })));
