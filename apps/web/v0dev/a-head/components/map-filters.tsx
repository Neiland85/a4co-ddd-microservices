    ...
    <div className="space-y-6">
        ...
        <div className="relative">
          ...
          {filters.search && (
            <Button
              ...
              className="absolute right-1 top-1/2 h-6 w-6 -translate-y-1/2 transform p-0 hover:bg-gray-100"
            >
              <X className="h-3 w-3" />
            </Button>
          )}
        ...
        <div className="grid grid-cols-1 gap-2">
          {categories.map(category => (
            <div
              key={category.value}
              className={cn(
                'flex cursor-pointer items-center justify-between rounded-lg border p-3 transition-all duration-200 hover:bg-gray-50',
      ...
      <div className="flex items-center space-x-3 rounded-lg bg-gray-50 p-3">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Label htmlFor="onlyOpen" className="cursor-pointer text-sm font-medium">
            Solo abiertos ahora
          </Label>
        </div>
      </div>
  ...
  return (
    <>
      ...
      <div className="mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4">
        <Card className="hover:shadow-natural-lg transition-all duration-300">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              ...
              <MapPin className="text-a4co-olive-600 h-8 w-8" />
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-natural-lg transition-all duration-300">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              ...
              <Filter className="text-a4co-clay-600 h-8 w-8" />
            </div>
          </CardContent>
        </Card>
          ...
          <SheetTrigger asChild>
            <Button variant="outline" className="relative w-full bg-transparent">
              ...
              {activeFiltersCount > 0 && (
                <Badge variant="secondary" className="bg-a4co-olive-100 text-a4co-olive-800 ml-2">
                  {activeFiltersCount}
                </Badge>
              )}
            </Button>
      ...
      <Card className="shadow-natural-lg mb-6 hidden lg:block">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
