      ...
      <main className="pt-16">
        <div className="container mx-auto px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
          <div className="mb-6 sm:mb-8">
            <h1 className="mb-2 text-2xl font-bold text-gray-900 sm:mb-4 sm:text-3xl lg:text-4xl">
              Mapa de Productores Artesanales
            </h1>
            <p className="max-w-3xl text-base text-gray-600 sm:text-lg">
              Descubre productores locales cerca de ti. Utiliza los filtros para encontrar
          ...
          <div className="grid grid-cols-1 gap-6 lg:gap-8 xl:grid-cols-4">
            ...
            <div className="xl:col-span-3">
                  ...
                  {isLoading ? (
                    <div className="flex h-full items-center justify-center bg-gray-100">
                      <div className="text-center">
                        <div className="border-a4co-olive-600 mx-auto mb-4 h-8 w-8 animate-spin rounded-full border-b-2"></div>
              ...
              {/* Results Summary */}
              <div className="shadow-natural mt-4 rounded-lg border border-gray-200 bg-white p-4 sm:mt-6">
