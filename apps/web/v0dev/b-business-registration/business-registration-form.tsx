      ...
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Completa la información de tu negocio para crear tu perfil</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input id="businessName" {...register("businessName")} placeholder="Ej: Mi Restaurante" />
              ...
              <div className="space-y-4">
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-gray-400 transition-colors">
                  ...
                  <label htmlFor="image-upload" className="cursor-pointer">
                    ...
                    <p className="mt-2 text-sm text-gray-600">Haz clic para subir imágenes o arrastra y suelta</p>
                    <p className="text-xs text-gray-500">JPG, PNG, GIF hasta 5MB cada una (máximo 5 imágenes)</p>
                  </label>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-gray-400 transition-colors">
                  ...
                  <label htmlFor="document-upload" className="cursor-pointer">
                    ...
                    <p className="mt-2 text-sm text-gray-600">Sube documentos adicionales (menús, catálogos, etc.)</p>
