        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-lg">
              Comparte tu arte y tradición cultural con el mundo. Registra tu taller artesanal y
              conecta con quienes valoran el trabajo hecho a mano.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="space-y-6">
                <h3 className="border-b border-amber-200 pb-2 text-xl font-semibold text-amber-700">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="Ej: Taller de Cerámica Maya"
                    />
                    {errors.artisanName && (
                      <p className="text-sm text-red-500">{errors.artisanName.message}</p>
                    )}
                  </div>
                      ...
                      <Select onValueChange={field.onChange} value={field.value}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="tradicion-familiar">
                            Tradición Familiar (generaciones)
                          </SelectItem>
                        </SelectContent>
                      </Select>
                    )}
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  {errors.techniques && (
                    <p className="text-sm text-red-500">{errors.techniques.message}</p>
                  )}
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-lg border-2 border-dashed border-amber-300 bg-amber-50 p-6 text-center transition-colors hover:border-amber-400">
                  <input
                    type="file"
                  ...
                  <label htmlFor="image-upload" className="cursor-pointer">
                    ...
                    <p className="mt-2 text-sm font-medium text-amber-700">
                      Sube fotos de tus mejores creaciones
                    </p>
                    ...
                    {imagePreview.map((preview, index) => (
                      <div key={index} className="group relative">
                        <img
                          ...
                          className="h-32 w-full rounded-lg border-2 border-amber-200 object-cover"
                        />
                        <Button
                          type="button"
                          variant="destructive"
              ...
              <div className="space-y-4">
                <h3 className="flex items-center gap-2 border-b border-amber-200 pb-2 text-xl font-semibold text-amber-700">
                ...
                <div className="rounded-lg border-2 border-dashed border-gray-300 p-6 text-center transition-colors hover:border-gray-400">
                  ...
                  <label htmlFor="document-upload" className="cursor-pointer">
                    ...
                    <p className="mt-2 text-sm text-gray-600">
                      Sube catálogos, certificados, artículos de prensa
                    </p>
              ...
              <div className="flex flex-col gap-4 border-t pt-6 sm:flex-row">
                <Button
                  type="button"
                  variant="outline"
                  className="flex-1 border-amber-300 bg-transparent text-amber-700 hover:bg-amber-50"
