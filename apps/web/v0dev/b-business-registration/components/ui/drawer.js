...
const DrawerContent = React.forwardRef(({ className, children, ...props }, ref) => ((0, jsx_runtime_1.jsxs)(DrawerPortal, { children: [(0, jsx_runtime_1.jsx)(DrawerOverlay, {}), (0, jsx_runtime_1.jsxs)(vaul_1.Drawer.Content, { ref: ref, className: (0, utils_1.cn)('bg-background fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] border', className), ...props, children: [(0, jsx_runtime_1.jsx)("div", { className: "bg-muted mx-auto mt-4 h-2 w-[100px] rounded-full" }), children] })] })));
...
const DrawerDescription = React.forwardRef(({ className, ...props }, ref) => ((0, jsx_runtime_1.jsx)(vaul_1.Drawer.Description, { ref: ref, className: (0, utils_1.cn)('text-muted-foreground text-sm', className), ...props })));
