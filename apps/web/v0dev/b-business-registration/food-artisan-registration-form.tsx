  ...
  .object({
    ...
    images: z
      ...
      .refine(
        ...
        'Cada imagen no debe exceder los 5MB.'
      )
      .refine(
    ...
    videos: z
      ...
      .refine(
        files => files.every(file => file.size <= MAX_VIDEO_SIZE),
        'Cada video no debe exceder los 50MB.'
      )
      .refine(
          ...
          <CardHeader className="text-center">
            <div className="mb-2 flex items-center justify-center gap-2">
              ...
              <CardTitle className="text-3xl font-bold text-gray-800">
                Registro de Productor y Creador
              </CardTitle>
            </div>
            <CardDescription className="text-lg">
              Comparte tus productos alimentarios tradicionales o servicios tecnológicos culturales.
              Conecta con quienes valoran la calidad artesanal y la innovación digital.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="space-y-6">
                <h3 className="border-b border-gray-200 pb-2 text-xl font-semibold text-gray-700">
                  Información Básica
                </h3>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    />
                    {errors.producerName && (
                      <p className="text-sm text-red-500">{errors.producerName.message}</p>
                    )}
                  </div>
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <Select onValueChange={field.onChange} value={field.value}>
                          ...
                          <SelectContent>
                            <SelectItem value="alimentario">
                              🍯 Productos Alimentarios Artesanales
                            </SelectItem>
                            <SelectItem value="tecnologico">
                              💻 Servicios Tecnológicos Culturales
                            </SelectItem>
                          </SelectContent>
                        </Select>
                      )}
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  {activityType === 'alimentario' && (
                    <div className="space-y-2">
                      ...
                      />
                      {errors.foodCategory && (
                        <p className="text-sm text-red-500">{errors.foodCategory.message}</p>
                      )}
                    </div>
                  )}
                  ...
                  {activityType === 'tecnologico' && (
                    <div className="space-y-2">
                      ...
                      />
                      {errors.techCategory && (
                        <p className="text-sm text-red-500">{errors.techCategory.message}</p>
                      )}
                    </div>
                  )}
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  {errors.productionMethods && (
                    <p className="text-sm text-red-500">{errors.productionMethods.message}</p>
                  )}
                </div>
              ...
              <div className="space-y-4">
                ...
                <div
                  className={`rounded-lg border-2 border-dashed p-6 text-center transition-colors hover:border-gray-400 ${
                    activityType === 'tecnologico'
                ...
                >
                  ...
                  <label htmlFor="image-upload" className="cursor-pointer">
                    ...
                    <p
                      className={`text-xs ${activityType === 'tecnologico' ? 'text-blue-600' : 'text-green-600'}`}
                    >
              ...
              {/* Galería de videos */}
              <div className="space-y-4">
                <h3 className="flex items-center gap-2 border-b border-gray-200 pb-2 text-xl font-semibold text-gray-700">
                  <Video className="h-5 w-5" />
                  {activityType === 'tecnologico' ? 'Videos de Proyectos' : 'Videos de Productos'}
                </h3>

                <div className="rounded-lg border-2 border-dashed border-purple-300 bg-purple-50 p-6 text-center transition-colors hover:border-purple-400">
                  <input
                    type="file"
                  ...
                  <label htmlFor="video-upload" className="cursor-pointer">
                    ...
                    <p className="text-xs text-purple-600">
                      MP4, MOV, AVI, WebM hasta 50MB cada uno (máximo 3 videos)
                    </p>
                  </label>
                </div>
                            ...
                            {activityType === 'tecnologico' ? (
                              <>
                                ...
                                <SelectItem value="intermedio">
                                  Intermedio (€200-800/proyecto)
                                </SelectItem>
                                <SelectItem value="avanzado">
                                  Avanzado (€800-2000/proyecto)
                                </SelectItem>
                                <SelectItem value="enterprise">
                                  Enterprise (€2000+/proyecto)
                                </SelectItem>
