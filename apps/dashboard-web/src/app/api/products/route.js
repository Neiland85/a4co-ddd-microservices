...
const mockProducts = [
    ...
    },
    {
        ...
        unit: 'bote 500g',
        seasonal: false,
        description: 'Aceitunas verdes aliñadas con receta tradicional familiar transmitida por generaciones.',
    ...
    },
    {
        ...
        unit: 'pieza',
        seasonal: false,
        description: 'Cerámica artesanal realizada con técnicas tradicionales del Renacimiento andaluz.',
...
async function GET(request) {
    ...
    try {
        ...
        if (location) {
            filteredProducts = filteredProducts.filter(product => product.location.municipality.toLowerCase().includes(location.toLowerCase()));
        }
        if (seasonal === 'true') {
