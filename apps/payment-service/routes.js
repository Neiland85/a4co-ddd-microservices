...
function setupPaymentRoutes() {
    ...
    router.post('/validate', async (req, res) => {
        try {
            const { paymentMethodType, paymentMethodId, customerId, amount, currency, orderId } = req.body;
    ...
    router.post('/process', async (req, res) => {
        try {
            const { orderId, customerId, paymentMethodType, paymentMethodId, amount, currency, description, customerEmail, customerPhone, billingAddress, } = req.body;
            if (!orderId ||
                !customerId ||
                !paymentMethodType ||
                !paymentMethodId ||
    ...
    router.get('/customer/:customerId', async (req, res) => {
        try {
            ...
            const result = await paymentController.getCustomerPaymentHistory(customerId, limit ? parseInt(limit) : undefined, offset ? parseInt(offset) : undefined);
            res.json(result);
        }
        catch (error) {
