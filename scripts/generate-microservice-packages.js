...
const serviceTemplates = {
  'user-service': {
    template: 'nestjs',
    description: 'Servicio de usuarios para a4co-ddd-microservices',
  },
  'inventory-service': {
    template: 'nestjs',
    description: 'Servicio de inventario para a4co-ddd-microservices',
  },
  'payment-service': {
    template: 'nestjs',
    description: 'Servicio de pagos para a4co-ddd-microservices',
  },
  'notification-service': {
    template: 'nestjs',
    description: 'Servicio de notificaciones para a4co-ddd-microservices',
  },
  'loyalty-service': {
    template: 'nestjs',
    description: 'Servicio de fidelización para a4co-ddd-microservices',
  },
  'geo-service': {
    template: 'nestjs',
    description: 'Servicio geográfico para a4co-ddd-microservices',
  },
  'event-service': {
    template: 'nestjs',
    description: 'Servicio de eventos para a4co-ddd-microservices',
  },
  'cms-service': { template: 'nestjs', description: 'Servicio CMS para a4co-ddd-microservices' },
  'chat-service': {
    template: 'nestjs',
    description: 'Servicio de chat para a4co-ddd-microservices',
  },
  'analytics-service': {
    template: 'nestjs',
    description: 'Servicio de analíticas para a4co-ddd-microservices',
  },
  'admin-service': {
    template: 'nestjs',
    description: 'Servicio de administración para a4co-ddd-microservices',
  },
  'artisan-service': {
    template: 'nestjs',
    description: 'Servicio de artesanos para a4co-ddd-microservices',
  },
};
