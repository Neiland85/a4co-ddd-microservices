...
const result = await protector.safeMatch(() => micromatch.match(files, patterns), patterns, {
  timeout: 1000,
...
import {
  ...
  safeMatch,
  safeIsMatch,
} from '@a4co/shared-utils/security/utils/safe-micromatch';
...
module.exports = {
  ...
  rules: {
    '@a4co/micromatch-security/no-dangerous-micromatch-patterns': [
      'error',
      {
