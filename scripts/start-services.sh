...
echo ""
echo "  Terminal 1 - User Service (puerto 3002):"
echo "  Terminal 1 - User Service (puerto 3002):"
echo "    cd apps/user-service && pnpm install && pnpm run dev"
echo ""
echo "  Terminal 2 - Product Service (puerto 3003):"
echo "    cd apps/product-service && pnpm install && pnpm run dev"
echo ""
echo "  Terminal 3 - Order Service (puerto 3004):"
echo "    cd apps/order-service && pnpm install && pnpm run dev"
echo ""
echo "  Terminal 4 - Payment Service (puerto 3005):"
